...
-- Fixed missing quotes around the date
...
select branch.branch_id,branch_name,first_name,salary,mgr_start_date from employee
inner join branch on employee.emp_id = branch.mgr_id;

select client_name,branch_name from branch
inner join client on branch.branch_id = client.branch_id;

select branch.branch_id ,supplier_name,branch_name from branch
inner join branch_supplier on branch.branch_id = branch_supplier.branch_id;

select supplier_name,branch_name from branch_supplier
left join branch on branch_supplier.branch_id = branch.branch_id;

select supplier_name,branch_name from branch_supplier
right join branch on branch_supplier.branch_id = branch.branch_id;
...
select * from employee
where emp_id in (
  select distinct works_with.emp_id from works_with 
